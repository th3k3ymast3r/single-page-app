...
<aside role="complementary">
	<ul>
		...
		<li><?php echo '<a class="active link" href="'.$xmlData->sitedata->sitenav->category[3]->submenu[4]->url.'">'.$xmlData->sitedata->sitenav->category[3]->submenu[4]->label.'</a>';?></li>
...
<div id="main" role="main"><?php echo $xmlData->sitedata->pages->cocktails->content; ?></div>
<script>
	$(document).ready(function(){
		$('title').text('<?php echo $xmlData->sitedata->pages->cocktails->title; ?>');
		$('meta[name="description"]').attr('content','<?php echo $xmlData->sitedata->pages->cocktails->metadescription; ?>');
