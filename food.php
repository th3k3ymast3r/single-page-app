...
<div id="main" role="main"><?php echo $xmlData->sitedata->pages->food->content; ?></div>
<script>
	$(document).ready(function(){
		$('title').text('<?php echo $xmlData->sitedata->pages->food->title; ?>');
		$('meta[name="description"]').attr('content','<?php echo $xmlData->sitedata->pages->food->metadescription; ?>');
