...
<div id="main" role="main"><?php echo $xmlData->sitedata->pages->recentmenu->content; ?></div>
<script>
	$(document).ready(function(){
		$('title').text('<?php echo $xmlData->sitedata->pages->recentmenu->title; ?>');
		$('meta[name="description"]').attr('content','<?php echo $xmlData->sitedata->pages->recentmenu->metadescription; ?>');
