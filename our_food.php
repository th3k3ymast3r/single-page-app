...
<aside role="complementary">
	<ul>
		<li><?php echo '<a class="active link" href="'.$xmlData->sitedata->sitenav->category[2]->submenu[0]->url.'">'.$xmlData->sitedata->sitenav->category[2]->submenu[0]->label.'</a>';?></li>
...
<div id="main" role="main"><?php echo $xmlData->sitedata->pages->ourfood->content; ?></div>
<script>
	$(document).ready(function(){
		$('title').text('<?php echo $xmlData->sitedata->pages->ourfood->title; ?>');
		$('meta[name="description"]').attr('content','<?php echo $xmlData->sitedata->pages->ourfood->metadescription; ?>');
