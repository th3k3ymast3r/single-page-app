...
<aside role="complementary">
	<ul>
		...
		<li><?php echo '<a class="active link" href="'.$xmlData->sitedata->sitenav->category[2]->submenu[2]->url.'">'.$xmlData->sitedata->sitenav->category[2]->submenu[2]->label.'</a>';?></li>
...
<div id="main" role="main"><?php echo $xmlData->sitedata->pages->starters->content; ?></div>
<script>
	$(document).ready(function(){
		$('title').text('<?php echo $xmlData->sitedata->pages->starters->title; ?>');
		$('meta[name="description"]').attr('content','<?php echo $xmlData->sitedata->pages->starters->metadescription; ?>');
