...
<aside role="complementary">
	<ul>
		...
		<li><?php echo '<a class="active link" href="'.$xmlData->sitedata->sitenav->category[3]->submenu[6]->url.'">'.$xmlData->sitedata->sitenav->category[3]->submenu[6]->label.'</a>';?></li>
...
<div id="main" role="main"><?php echo $xmlData->sitedata->pages->whitewine->content; ?></div>
<script>
	$(document).ready(function(){
		$('title').text('<?php echo $xmlData->sitedata->pages->whitewine->title; ?>');
		$('meta[name="description"]').attr('content','<?php echo $xmlData->sitedata->pages->whitewine->metadescription; ?>');
