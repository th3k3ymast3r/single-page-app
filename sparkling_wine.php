...
<aside role="complementary">
	<ul>
		<li><?php echo '<a class="active link" href="'.$xmlData->sitedata->sitenav->category[3]->submenu[0]->url.'">'.$xmlData->sitedata->sitenav->category[3]->submenu[0]->label.'</a>';?></li>
...
<div id="main" role="main"><?php echo $xmlData->sitedata->pages->sparklingwine->content; ?></div>
<script>
	$(document).ready(function(){
		$('title').text('<?php echo $xmlData->sitedata->pages->sparklingwine->title; ?>');
		$('meta[name="description"]').attr('content','<?php echo $xmlData->sitedata->pages->sparklingwine->metadescription; ?>');
