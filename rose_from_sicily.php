...
<aside role="complementary">
	<ul>
		...
		<li><?php echo '<a class="link" href="'.$xmlData->sitedata->sitenav->category[3]->submenu[2]->url.'">'.$xmlData->sitedata->sitenav->category[3]->submenu[2]->label.'</a>';?></li>
		...
		<li><?php echo '<a class="active link" href="'.$xmlData->sitedata->sitenav->category[3]->submenu[5]->url.'">'.$xmlData->sitedata->sitenav->category[3]->submenu[5]->label.'</a>';?></li>
...
<div id="main" role="main"><?php echo $xmlData->sitedata->pages->rosefromsicily->content; ?></div>
<script>
	$(document).ready(function(){
		$('title').text('<?php echo $xmlData->sitedata->pages->rosefromsicily->title; ?>');
		$('meta[name="description"]').attr('content','<?php echo $xmlData->sitedata->pages->rosefromsicily->metadescription; ?>');
