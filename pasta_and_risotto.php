...
<aside role="complementary">
	<ul>
		...
		<li><?php echo '<a class="active link" href="'.$xmlData->sitedata->sitenav->category[2]->submenu[3]->url.'">'.$xmlData->sitedata->sitenav->category[2]->submenu[3]->label.'</a>';?></li>
		...
		<li><?php echo '<a class="link" href="'.$xmlData->sitedata->sitenav->category[2]->submenu[5]->url.'">'.$xmlData->sitedata->sitenav->category[2]->submenu[5]->label.'</a>';?></li>
...
<div id="main" role="main"><?php echo $xmlData->sitedata->pages->pastaandrisotto->content; ?></div>
<script>
	$(document).ready(function(){
		$('title').text('<?php echo $xmlData->sitedata->pages->pastaandrisotto->title; ?>');
		$('meta[name="description"]').attr('content','<?php echo $xmlData->sitedata->pages->pastaandrisotto->metadescription; ?>');
